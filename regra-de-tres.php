      ...
      <div class="card">
        <div class="card-content">
          <div class="px-3">
            <form class="form">
              <div class="form-body">
                <h4 class="form-section"><i class="ft-user"></i> Calculadora de Regra de Três</h4>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="projectinput1">Este número</label>
                      <input type="number" id="type-a-top" class="form-control input -type-a round">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="projectinput2">Está para este</label>
                      <input type="number" id="type-b-top" class="form-control input -type-b round">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="projectinput3">Assim como este número</label>
                      <input type="number" id="type-a-bottom" class="form-control input -type-a round">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="projectinput4">Está para este</label>
                      <input type="number" id="type-b-bottom" class="form-control input -type-b round">
                    </div>
                  </div>
                </div>
              ...
              <div class="form-actions">
                <button type="reset" class="btn btn-raised btn-raised btn-warning mr-1 round">
                  <i class="ft-trash"id="delete"></i> Limpar
                </button>
              </div>
            </form>
          </div>
