      ...
      <div class="main-panel">
        ...
        <div class="main-content">
          <div class="content-wrapper"><!--Statistics cards Starts-->
			<div class="row">
				<div class="content-header"><h2>Editar Tema</h2></div>
			</div>
		<div class="row">
			<div class="col-12">
			  <div class="card">
				...
				<center>
				  <h4 class="card-title">Vamos deixar o App com sua cara?</h4>
				  <p class="card-text">Aqui você pode editar as preferências da aparência do App.</p>
				  </center>
				</div>
			  ...
			  <center>
				<div class="card-header">
				  <h4 class="card-title"><i class="ft-arrow-right"></i>Cor da barra de menu lateral <i class="ft-arrow-left"></i></h4>
				  <p class="card-text">Aqui você pode editar as cores da barra de menu lateral, <br>Clique no botão correspondente e a página será atualizada com a mudança já salva.</p>
				</div>
				<div class="card-content">
		  ...
		  <?php
							...
							{
						?>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-pomegranate.php?id=<?php echo $row['id']; ?>'" class="btn btn-raised btn-icon gradient-pomegranate" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></i></font></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-king-yna.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon gradient-king-yna" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o" ></i></font></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-ibiza-sunset.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon gradient-ibiza-sunset" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></font></i></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-flickr.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon gradient-flickr" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></i></font></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-purple-bliss.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon gradient-purple-bliss" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></i></font></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-man-of-steel.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon gradient-man-of-steel" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></i></font></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-purple-love.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon gradient-purple-love" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></font></i></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-black.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon bg-black" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></i></font></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-grey.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon bg-grey" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></i></font></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-primary.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon bg-primary" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></i></font></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-success.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon bg-success" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></i></font></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-warning.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon bg-warning" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></i></font></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-info.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon bg-info" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></i></font></button>
			<button onclick="location.href='php/processar/tema/cor-barra-lateral-danger.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised btn-icon bg-danger" style="border-style: solid; border-width: 1px; border-color: black;"><font color="#fff"><i class="fa fa-star-o"></i></font></button>
			<?php
							}
						?>
          </div>
			  ...
			  <center>
				<div class="card-header">
				  <h4 class="card-title"><i class="ft-arrow-right"></i>Cor da Interface <i class="ft-arrow-left"></i></h4>
				  <p class="card-text">Aqui você pode editar as cores da interface do App, <br>Clique no botão correspondente e a página será atualizada com a mudança já salva.</p>
				</div>
				<div class="card-content">
		  ...
		  <?php
							...
							{
						?>
			                  <button onclick="location.href='php/processar/tema/cor-tema-light.php?id=<?php echo $row['id']; ?>'" style="border-style: solid; border-width: 1px; border-color: black;" type="button" class="btn btn-raised btn-light btn-min-width mr-1 mb-1">Light</button>
		  <button onclick="location.href='php/processar/tema/cor-tema-dark.php?id=<?php echo $row['id']; ?>'" style="border-style: solid; border-width: 1px; border-color: black;" type="button" class="btn btn-raised btn-dark btn-min-width mr-1 mb-1">Dark</button>
		  <?php
							}
						?>
          </div>
			  ...
			  <center>
				<div class="card-header">
				  <h1 class="card-title"><i class="ft-arrow-right"></i>Imagem de fundo da Barra Lateral <i class="ft-arrow-left"></i></h1>
				  <p class="card-text">Aqui você pode escolher a imagem de fundo da barra lateral, <br>Clique no botão correspondente e a página será atualizada com a mudança já salva.</p>
				</div>
				<div class="card-content">
		  ...
		  <?php
							...
							{
						?>
			<a href="#" onclick="location.href='php/processar/tema/imagem-bg-lateral-01.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised" ><img width="130px" style="border: 1px solid black; border-radius: 25px;" src="app-assets/img/sidebar-bg/01.jpg"></a>
			<a href="#" onclick="location.href='php/processar/tema/imagem-bg-lateral-02.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised" ><img width="130px" style="border: 1px solid black; border-radius: 25px;" src="app-assets/img/sidebar-bg/02.jpg"></a>
			<a href="#" onclick="location.href='php/processar/tema/imagem-bg-lateral-03.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised" ><img width="130px" style="border: 1px solid black; border-radius: 25px;" src="app-assets/img/sidebar-bg/03.jpg"></a>
			<a href="#" onclick="location.href='php/processar/tema/imagem-bg-lateral-04.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised" ><img width="130px" style="border: 1px solid black; border-radius: 25px;" src="app-assets/img/sidebar-bg/04.jpg"></a>
			<a href="#" onclick="location.href='php/processar/tema/imagem-bg-lateral-05.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised" ><img width="130px" style="border: 1px solid black; border-radius: 25px;" src="app-assets/img/sidebar-bg/05.jpg"></a>
			<a href="#" onclick="location.href='php/processar/tema/imagem-bg-lateral-06.php?id=<?php echo $row['id']; ?>'"type="button" class="btn btn-raised" ><img width="130px" style="border: 1px solid black; border-radius: 25px;" src="app-assets/img/sidebar-bg/06.jpg"></a>
			<?php
							}
						?>
          </div>
